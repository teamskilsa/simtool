...
import { FolderOpen, Save, Download, Upload } from 'lucide-react';
...
export function SectionToolbar({ type, currentData, onLoad, loadedFromName }: SectionToolbarProps) {
  ...
  return (
    // No box and no section label of its own: this sits in a group heading,
    // which already names the section and draws the rule under it.
